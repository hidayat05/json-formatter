...
#[cfg(target_arch = "wasm32")]
#[wasm_bindgen]
pub fn format_json_wasm(input: String) -> Result<String, String> {
    format_json_impl(input)
}

#[cfg(target_arch = "wasm32")]
#[wasm_bindgen]
pub fn minify_json_wasm(input: String) -> Result<String, String> {
    minify_json_impl(input)
}

#[cfg(target_arch = "wasm32")]
#[wasm_bindgen]
pub fn json_to_string_wasm(input: String) -> Result<String, String> {
    json_to_string_impl(input)
}

#[cfg(target_arch = "wasm32")]
#[wasm_bindgen]
pub fn string_to_json_wasm(input: String) -> Result<String, String> {
    string_to_json_impl(input)
}

#[cfg(target_arch = "wasm32")]
#[wasm_bindgen]
pub fn json_to_proto_wasm(input: String) -> Result<String, String> {
    json_to_proto_impl(input)
}

#[cfg(target_arch = "wasm32")]
#[wasm_bindgen]
pub fn proto_to_json_wasm(input: String) -> Result<String, String> {
    proto_to_json_impl(input)
}

#[cfg(target_arch = "wasm32")]
#[wasm_bindgen]
pub fn json_to_class_wasm(input: String, language: String, name: String) -> Result<String, String> {
    json_to_class_impl(input, language, name)
}

#[cfg(target_arch = "wasm32")]
#[wasm_bindgen]
pub fn remove_background_wasm(image_data: String, tolerance: u32) -> Result<String, String> {
    remove_background_impl(image_data, tolerance)
}
...
pub fn remove_background_impl(image_data: String, tolerance: u32) -> Result<String, String> {
    ...
    let tolerance_sq = (tolerance as f64).powi(2) * 3.0;
...
pub fn minify_json_impl(input: String) -> Result<String, String> {
    if input.trim().is_empty() {
        return Err("Input is empty".to_string());
    }

    let parsed: Value = serde_json::from_str(&input).map_err(|e| format!("Invalid JSON: {}", e))?;
    let result = serde_json::to_string(&parsed).map_err(|e| format!("Failed to minify: {}", e))?;
    Ok(result)
}

pub fn format_json_impl(input: String) -> Result<String, String> {
    if input.trim().is_empty() {
        return Err("Input is empty".to_string());
    }
...
pub fn json_to_string_impl(input: String) -> Result<String, String> {
    if input.trim().is_empty() {
        return Err("Input is empty".to_string());
    }
...
pub fn string_to_json_impl(input: String) -> Result<String, String> {
...
pub fn json_to_proto_impl(input: String) -> Result<String, String> {
    if input.trim().is_empty() {
        return Err("Input is empty".to_string());
    }
...
pub fn proto_to_json_impl(input: String) -> Result<String, String> {
    if input.trim().is_empty() {
        return Err("Input is empty".to_string());
    }
...
pub fn json_to_class_impl(input: String, language: String, name: String) -> Result<String, String> {
    if input.trim().is_empty() {
        return Err("Input is empty".to_string());
    }
...
mod tests {
  ...
  "email": "john@example.com"
        ...
        .to_string();
        let result = json_to_proto_impl(input).unwrap();
  ...
  "age": 30
        ...
        .to_string();
        let result = json_to_class_impl(input, "python".to_string(), "User".to_string()).unwrap();
  ...
  "age": 30
        ...
        .to_string();
        let result = json_to_class_impl(input, "rust".to_string(), "User".to_string()).unwrap();
  ...
  "name": "John"
        ...
        .to_string();
        let result = json_to_class_impl(input, "java".to_string(), "User".to_string()).unwrap();
...
message Root {
  ...
  bool is_active = 3;
        ...
        .to_string();
        let result = proto_to_json_impl(input).unwrap();
        assert!(result.contains("\"name\""));
        assert!(result.contains("\"age\""));
...
message Root {
  ...
  repeated int32 numbers = 2;
    ...
    fn test_proto_to_json_empty_input() {
        let result = proto_to_json_impl("".to_string());
